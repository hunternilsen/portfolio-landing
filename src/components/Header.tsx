  ...
  return (
    <header className="header">
      <div className="header-inner">
        <div className="header-name"><a href="#/">Hunter Nilsen</a></div>
        ...
        <div className="header-right">
          ...
          <div className="header-social">
            ...
            <a href="https://github.com/hunternilsen" target="_blank" rel="noopener noreferrer" aria-label="GitHub profile">
              <svg viewBox="0 0 24 24" aria-hidden="true">
